...
(function ($) {
  ...
  $(".style3-slider-small").slick({
    ...
    arrows: true,
    prevArrow:
      '<button class="slick-prev"><i class="bi bi-arrow-left-short"></i></button>',
    nextArrow:
      '<button class="slick-next"><i class="bi bi-arrow-right-short"></i></button>',
    dots: false,
    centerMode: true,
  ...
  $(
    ".slider-big, .style2-slider-big, .style4-slider-big, .slider-big-6, .slider-big-7"
  ).magnificPopup({
    delegate: "a",
    type: "image",
    showCloseBtn: true,
